...
#ifndef __MANACOMMONS_PLUGIN_PLUGIN_INTERFACE__
#define __MANACOMMONS_PLUGIN_PLUGIN_INTERFACE__ 1
...
class IPlugin {
  public:
     ...
     *
     *	If this value doesn't match PluginManager::API_VERSION, the plugin will not be
     *loaded.
     *
     ...
     *
     *	Result's constructor has been made private because it needs to receive the
     *plugin's name in order to fill its internal OutputTreeNode. This function hides the
     *fact that the plugin name is forwarded.
     */
...
#endif // __MANACOMMONS_PLUGIN_PLUGIN_INTERFACE__
