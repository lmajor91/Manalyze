...
#include "manacommons/plugin_framework/dynamic_library.h"
#include "manacommons/plugin_framework/plugin.h"
#include "manacommons/plugin_framework/plugin_interface.h"

#ifndef __MANACOMMONS_PLUGIN_PLUGIN_MANAGER__
#define __MANACOMMONS_PLUGIN_PLUGIN_MANAGER__ 1
 ...
 *
 *	Simply contains a reference to the plugin object, and an optional pointer to the
 *shared library in the case of dynamic plugins.
 */
class RegisterEntry {
  public:
...
#endif // __MANACOMMONS_PLUGIN_PLUGIN_MANAGER__
